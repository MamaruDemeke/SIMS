...
@section('title', 'Edit Product - YEGNA TRADING PLC')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <select name="unit" id="unit" required
                        ...
                        <option value="sqm" {{ old('unit', $product->unit) == 'sqm' ? 'selected' : '' }}>Square Meter (sqm)</option>
                ...
                <div>
                    ...
                    <input type="text" name="brand" id="brand" value="{{ old('brand', $product->brand) }}"
                           class="w-full px-3 py-2.5 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('brand') border-red-500 @enderror"
                           placeholder="e.g. Derba, Mugher, EAL">
                    @error('brand')
                        <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                    @enderror
                </div>
