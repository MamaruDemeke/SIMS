...
@section('title', 'Edit User - YEGNA TRADING PLC')
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <form method="POST" action="{{ route('users.update', $user) }}">
            ...
            <div class="space-y-5">
                ...
                {{-- Active / Deactivated toggle. Unchecking deactivates the account. --}}
                <div>
                    ...
                    <label class="inline-flex items-center gap-2 cursor-pointer">
                        ...
                        <span class="text-sm text-gray-600">
                            {{ old('is_active', $user->is_active) ? 'Active' : 'Deactivated' }}
                        </span>
                    </label>
                ...
                <p class="text-xs text-gray-500">Leave the password fields blank to keep the current password.</p>
            </div>
