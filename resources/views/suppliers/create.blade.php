                ...
                <div class="border-t border-gray-200 pt-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                        <div>
                            ...
                            <input type="text" name="default_type" id="default_type" value="{{ old('default_type') }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="default_diameter" id="default_diameter" value="{{ old('default_diameter') }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="default_size" id="default_size" value="{{ old('default_size') }}"
